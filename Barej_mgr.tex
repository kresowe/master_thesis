...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.6\textwidth]{img/phase-diag-qcd3-ab_.png}
	\vspace{-0.1in}
...
\paragraph{}
Następnie użyto tych samych funkcji emisji dla \textit{minimum bias} (Rys. \ref{fig:F0}(a)), aby odtworzyć rozkłady dla symetrycznych zderzeń $^{63}$Cu+$^{63}$Cu i $^{197}$Au+$^{197}$Au. Średnie liczby zranionych konstytuentów we wszystkich trzech modelach zaprezentowano w \Crefrange{table:Cu-Cu}{table:Au-Au}.
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.75\textwidth]{img/unwound-min-bias.pdf}
	\vspace{-0.1in}
